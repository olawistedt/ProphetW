...
NOTARIZE_BUNDLE_ID=com.Witech.ProphetW
NOTARIZE_BUNDLE_ID_DEMO=com.Witech.ProphetW.DEMO
...
#if [ $DEMO == 1 ]
#then
#  git checkout installer/ProphetW.iss
#  git checkout installer/ProphetW.pkgproj
