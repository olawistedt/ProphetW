...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=ProphetW Demo Installer\n"
      else:
        line="OutputBaseFilename=ProphetW Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the ProphetW Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the ProphetW installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=ProphetW Demo installer\n"
     else:
       line="SetupWindowTitle=ProphetW installer\n"
